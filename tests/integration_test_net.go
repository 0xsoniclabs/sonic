...
type IntegrationTestNet struct {
	...
	nodes                []integrationTestNodeState
...
type integrationTestNodeState struct {
	directory string
	httpPort  int
...
func startIntegrationTestNet(
	...
	net := &IntegrationTestNet{
		...
		nodes: make([]integrationTestNodeState, numNodes),
	}
	net.Session.net = net
...
func (n *integrationTestNodeState) getStateDir() string {
