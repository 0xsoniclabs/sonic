...
//
//	mockgen -source=backend.go -destination=../ethapi/backend_mock.go -package=ethapi
//
...
import (
	...
	backend "github.com/0xsoniclabs/sonic/api/backend"
...
func (m *MockBackend) Progress() backend.PeerProgress {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Progress")
	ret0, _ := ret[0].(backend.PeerProgress)
	return ret0
}
...
// HeaderByNumber mocks base method.
func (m *MockchainContextBackend) HeaderByNumber(arg0 context.Context, arg1 rpc.BlockNumber) (*evmcore.EvmHeader, error) {
	m.ctrl.T.Helper()
