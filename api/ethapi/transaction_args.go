...
func (args *TransactionArgs) toTransaction() *types.Transaction {
	...
	case len(args.AuthorizationList) > 0:
		...
		data = &types.SetCodeTx{
			...
			Nonce:      uint64(*args.Nonce),
			Gas:        uint64(*args.Gas),
			GasFeeCap:  utils.BigIntToUint256Clamped((*big.Int)(args.MaxFeePerGas)),
			GasTipCap:  utils.BigIntToUint256Clamped((*big.Int)(args.MaxPriorityFeePerGas)),
	...
	case args.BlobFeeCap != nil || len(args.BlobHashes) > 0:
		...
		data = &types.BlobTx{
			...
			Data:       args.data(),
			AccessList: al,
			BlobFeeCap: utils.BigIntToUint256Clamped((*big.Int)(args.BlobFeeCap)),
			BlobHashes: args.BlobHashes,
		}
