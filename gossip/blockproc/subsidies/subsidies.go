...
// TODO(#1016): Remove after callers migrate to Sponsorship.Overhead().Size.
...
// TODO(#1016): Remove and rename IsCoveredV2 to IsCovered.
func IsCovered(
...
// TODO(#1016): Remove after callers migrate to NewFundBackedSponsorship(...).GetPostTransactions(...).
