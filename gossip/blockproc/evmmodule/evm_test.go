...
func TestOperaEVMProcessor_Finalize_DoesNotBlocksOn_WhenBlockIsOlderThanOneHour(t *testing.T) {
...
func TestOperaEVMProcessor_Finalize_DoesNotBlocksOnSyncChannel_OnNilSyncChannel(t *testing.T) {
	synctest.Test(t, func(t *testing.T) {
		ctrl := gomock.NewController(t)
		stateDb := state.NewMockStateDB(ctrl)
