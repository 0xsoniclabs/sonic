...
// Source: gossip/blockproc/interface.go
//
// Generated by this command:
//
//	mockgen -source=gossip/blockproc/interface.go -destination=gossip/blockproc/interface_mock.go -package=blockproc
//
...
// Start mocks base method.
func (m *MockEVM) Start(blockNumber idx.Block, blockTime inter.Timestamp, epoch idx.Epoch, statedb state.StateDB, reader evmcore.DummyChain, parent *evmcore.EvmHeader, onNewLog func(*core_types.Log), net opera.Rules, evmCfg *params.ChainConfig, prevrandao common.Hash, metrics evmcore.BlockExecutionMetrics) EVMProcessor {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Start", blockNumber, blockTime, epoch, statedb, reader, parent, onNewLog, net, evmCfg, prevrandao, metrics)
	ret0, _ := ret[0].(EVMProcessor)
	return ret0
}

// Start indicates an expected call of Start.
func (mr *MockEVMMockRecorder) Start(blockNumber, blockTime, epoch, statedb, reader, parent, onNewLog, net, evmCfg, prevrandao, metrics any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Start", reflect.TypeOf((*MockEVM)(nil).Start), blockNumber, blockTime, epoch, statedb, reader, parent, onNewLog, net, evmCfg, prevrandao, metrics)
}
