...
func (m *MockExternal) GetRules() sonic.Rules {
	m.ctrl.T.Helper()
...
func (m *MockExternal) GetUpgradeHeights() []sonic.UpgradeHeight {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUpgradeHeights")
	ret0, _ := ret[0].([]sonic.UpgradeHeight)
	return ret0
}
...
// GetRules mocks base method.
func (m *MockReader) GetRules() sonic.Rules {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRules")
	ret0, _ := ret[0].(sonic.Rules)
	return ret0
