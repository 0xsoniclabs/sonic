...
func (m *MockExternal) Block(arg0 common.Hash, number uint64) *evmcore.EvmBlock {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Block", arg0, number)
	ret0, _ := ret[0].(*evmcore.EvmBlock)
	return ret0
}

// Block indicates an expected call of Block.
func (mr *MockExternalMockRecorder) Block(arg0, number any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Block", reflect.TypeOf((*MockExternal)(nil).Block), arg0, number)
}
