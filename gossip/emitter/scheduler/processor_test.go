...
func TestEvmProcessor_Run_IfExecutionSucceeds_ReportsSuccessAndGasUsage(t *testing.T) {
	...
	runner.EXPECT().Run(0, nil).Return(evmcore.ExecutionSummary{ProcessedTransactions: []core_types.ProcessedTransaction{{
...
func TestEvmProcessor_Run_IfRequestedTransactionIsNotExecuted_AFailedExecutionIsReported(t *testing.T) {
	...
	runner.EXPECT().Run(0, tx).Return(evmcore.ExecutionSummary{ProcessedTransactions: []core_types.ProcessedTransaction{{
...
func TestEvmProcessor_Run_IfExecutionFailed_ReportsAFailedExecution(t *testing.T) {
	...
	t.Run("no receipt", func(t *testing.T) {
		...
		runner := NewMockevmProcessorRunner(ctrl)
		tx := &types.Transaction{}
		runner.EXPECT().Run(0, gomock.Any()).Return(evmcore.ExecutionSummary{ProcessedTransactions: []core_types.ProcessedTransaction{
