...
func (s *Store) GetLiveStateDb(stateRoot hash.Hash, bundleTracker BundleTracker) (state.StateDB, error) {
	...
	return CreateCarmenStateDb(s.liveStateDb, bundleTracker), nil
}
...
func (s *Store) GetCurrentStateDb() (state.StateDB, error) {
	...
	return CreateCarmenStateDb(stateDb, nil), nil
}
