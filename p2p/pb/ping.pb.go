...
// Ping is a health-probe request. It carries an opaque nonce that the responder
// echoes, so the prober can match the response to its request and measure the
// round-trip time locally.
type Ping struct {
...
// Pong answers a Ping: it echoes the nonce and reports the responder's current
// self-described status. Additional status fields are added here as further
// numbered fields (backward compatible).
type Pong struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Nonce         []byte   `protobuf:"bytes,1,opt,name=nonce,proto3" json:"nonce,omitempty"`
	Role          NodeRole `protobuf:"varint,2,opt,name=role,proto3,enum=sonic.p2p.proto.NodeRole" json:"role,omitempty"`
...
func (x *Pong) GetClientVersion() string {
	if x != nil {
...
func (x *Pong) GetBlockHeight() uint64 {
	if x != nil {
...
var file_ping_proto_rawDesc = []byte{
	,
	...
	0x28, 0x04, 0x52, 0x0b, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x42,
...
var file_ping_proto_goTypes = []interface{}{
	(*Ping)(nil),  // 0: sonic.p2p.proto.Ping
	(*Pong)(nil),  // 1: sonic.p2p.proto.Pong
	(NodeRole)(0), // 2: sonic.p2p.proto.NodeRole
}
var file_ping_proto_depIdxs = []int32{
	2, // 0: sonic.p2p.proto.Pong.role:type_name -> sonic.p2p.proto.NodeRole
