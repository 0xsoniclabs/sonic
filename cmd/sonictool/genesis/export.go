...
func exportCommitteeCertificates(ctx context.Context, gdb *gossip.Store, writer *unitWriter, to consensus.BlockID) error {
...
func exportBlockCertificates(ctx context.Context, gdb *gossip.Store, writer *unitWriter, to consensus.BlockID) error {
