...
//
//	mockgen -source=bundle_precheck.go -destination=bundle_precheck_mock.go -package=corebundles
//
...
func (m *MockChainState) GetLatestHeader() *coretypes.EvmHeader {
	m.ctrl.T.Helper()
...
func (m *MockChainState) Header(hash common.Hash, number uint64) *coretypes.EvmHeader {
	m.ctrl.T.Helper()
