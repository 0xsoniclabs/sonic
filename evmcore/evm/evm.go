...
func NewEVMBlockContext(header *coretypes.EvmHeader, chain coretypes.DummyChain, author *common.Address) vm.BlockContext {
...
func GetHashFn(ref *coretypes.EvmHeader, chain coretypes.DummyChain) func(n uint64) common.Hash {
