...
//
//	mockgen -source=subsidies_integration.go -destination=subsidies_integration_mock.go -package=coresubsidies
//

// Package coresubsidies is a generated GoMock package.
