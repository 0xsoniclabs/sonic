...
type Payload struct {
	...
	// a validator responsible for proposing a block fails to du so in a given
	...
	// The number of the last proposal block seen by the event containing this
	// payload. A proposal is "seen" if there is an event in the ancestry of
	// this event that contains the given block number. If there are multiple,
	// the highest number is to be reported. If this event contains a proposal,
	// the number of the proposed block is to be reported.
	//
...
var file_payload_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xfc, 0x01, 0x0a, 0x07, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x18,
