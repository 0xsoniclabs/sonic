...
func FakeGenesisStore(num idx.Validator, balance, stake *big.Int, profile opera.FakeProfile) *genesisstore.Store {
	return FakeGenesisStoreWithRules(num, balance, stake, opera.FakeNetRules(profile))
}
